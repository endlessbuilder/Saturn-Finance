...
impl<'a, 'b> BankAccountWithPriceFeed<'a, 'b> {
    ...
    //         Some(side) => {
    //             let bank_al = AccountLoader::<Bank>::try_from(&'a self.bank)?;
    //             let bank = bank_al.load()?;
    //             match side {
...
impl<'a, 'b> RiskEngine<'a, 'b> {
    ...
    //     &'a self,
    //     requirement_type: &'b RiskRequirementType,
    // ) -> MarginfiResult<(I80F48, I80F48)> {
    ...
    // fn check_account_risk_tiers(&'a self) -> MarginfiResult {
