use anchor_lang::{
    err, prelude::*, solana_program::instruction::Instruction, Key, Result,
};

use super::ix_utils::{self, InstructionLoader};
pub use crate::{
    context::{FlashBorrowReserveLiquidity, FlashRepayReserveLiquidity},
    LendingError,
};

// use crate::instruction::FlashRepayReserveLiquidity as FlashRepayReserveLiquidityArgs;
// use crate::instruction::FlashBorrowReserveLiquidity as FlashBorrowReserveLiquidityArgs;
...
//     let discriminator = crate::instruction::FlashBorrowReserveLiquidity::DISCRIMINATOR;
...
//     borrow_index: usize,
// ) -> Result<()> {
//     let repay_ix_data = FlashRepayReserveLiquidity::try_from_slice(&repay_ix.data[8..])?;
