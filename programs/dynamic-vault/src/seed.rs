...
/// Collateral vault prefix
pub static COLLATERAL_VAULT_PREFIX: &str = "collateral_vault";
// /// Fee vault prefix
// pub static FEE_VAULT_PREFIX: &str = "fee_vault";
/// Solend obligation prefix
pub static SOLEND_OBLIGATION_PREFIX: &str = "solend_obligation";
/// Solend Obligation owner prefix
pub static SOLEND_OBLIGATION_OWNER_PREFIX: &str = "solend_obligation_owner";
/// Kamino obligation prefix
pub static KAMINO_OBLIGATION_PREFIX: &str = "kamino_obligation";
/// Solend Obligation owner prefix
pub static KAMINO_OBLIGATION_OWNER_PREFIX: &str = "kamino_obligation_owner";
