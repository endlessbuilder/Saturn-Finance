...
pub fn handle(ctx: Context<UnStakeSTF>, amount_to_unstake: u64) -> Result<()> {
    ...
    require!(personal.total_staked_index as u64 > amount_to_unstake, Error::UnstakingError)
    ...
    let accounts = TransferChecked {
        from: treasury_token_account.pda.to_account_info(),
        to: user_token_account.owner_ata.to_account_info(),
        authority: treasury_token_account.pda.to_account_info(),
